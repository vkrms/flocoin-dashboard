...
export function Sidebar({
  ...
  return <aside className={`h-full bg-[#18181b] dark:bg-[#18181b] light:bg-white border-r border-[#3333] dark:border-[#3333] light:border-gray-200 flex flex-col transition-all duration-300 ease-in-out ${collapsed ? 'lg:w-[70px]' : 'lg:w-[240px]'}`}>
      <div className="flex h-16 items-center justify-center border-b border-[#3333] dark:border-[#3333] light:border-gray-200 px-4">
      ...
      <div className="border-t border-[#3333] dark:border-[#3333] light:border-gray-200 p-4 space-y-3">
        ...
        <button onClick={onToggleCollapse} className={`flex items-center gap-2 w-full px-3 py-2 text-sm rounded-md hover:bg-[#3333] dark:hover:bg-[#3333] light:hover:bg-gray-100 text-gray-400 hover:text-white dark:hover:text-white light:hover:text-gray-800 transition-colors ${collapsed ? 'justify-center' : ''}`}>
...
function NavItem({
  ...
  return <div className="space-y-1">
      <div className={`flex items-center gap-3 px-3 py-2 rounded-md cursor-pointer transition-colors ${collapsed ? 'justify-center' : ''} ${active ? 'bg-[#8B5CF6]/20 dark:bg-[#8B5CF6]/20 light:bg-[#8B5CF6]/20 text-white dark:text-white light:text-gray-800' : 'text-gray-400 hover:bg-[#3333] dark:hover:bg-[#3333] light:hover:bg-gray-100 hover:text-white dark:hover:text-white light:hover:text-gray-800'}`} onClick={handleClick} title={collapsed ? label : undefined}>
        {icon}
        {!collapsed && <>
      ...
      {!collapsed && subItems && subItems.length > 0 && isOpen && <div className="pl-9 space-y-1">
          {subItems.map((item, index) => <div key={index} className={`flex items-center px-3 py-1.5 rounded-md cursor-pointer transition-colors ${item.active ? 'bg-[#8B5CF6]/20 dark:bg-[#8B5CF6]/20 light:bg-[#8B5CF6]/20 text-white dark:text-white light:text-gray-800' : 'text-gray-400 hover:bg-[#3333] dark:hover:bg-[#3333] light:hover:bg-gray-100 hover:text-white dark:hover:text-white light:hover:text-gray-800'}`}>
