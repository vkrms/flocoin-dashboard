...
export function Checkbox({
  ...
  return <div className="relative flex items-center">
      ...
      <div onClick={onChange} className={`h-4 w-4 rounded border border-[#3f3f46] flex items-center justify-center cursor-pointer ${isChecked ? 'bg-[#8B5CF6] border-[#8B5CF6]' : 'bg-[#27272a]'} ${className}`}>
